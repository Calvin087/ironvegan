const restaurantesEN = [
  {
    title: "Zenith Brunch & Cocktails",
    address: "Calle Valverde 28, 28004 Madrid Spain",
    phone: "+34 912 12 42 99",
    cols2: [
      "€8 - €12",
      "Cafe, European, Healthy, International",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
      "https://media-cdn.tripadvisor.com/media/photo-s/17/4e/e7/af/brunch.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-s/17/4e/e7/f3/brunch.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-f/17/4e/e3/21/oreo-pancake.jpg",
    ],
  },
  {
    title: "Pizzart Villa Canalejas",
    address: "Calle Arlaban 1, 28014 Madrid Spain",
    phone: "+34 911 08 89 92",
    cols2: [
      "€6 - €15",
      "Italian, Pizza, Mediterranean, Healthy, Tuscan, Romana, Lazio, Sicilian, Central-Italian, Southern-Italian",
  ...
  {
    title: "Levél Veggie Bistro",
    address: "Avenida Menendez Pelayo 61, 28009 Madrid Spain",
    phone: "+34 911 27 57 52",
    cols2: [
      "€30 - €45",
      "Mediterranean, European, Healthy, Fusion",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
      "https://media-cdn.tripadvisor.com/media/photo-s/10/0b/3a/1d/interior.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-s/1c/71/0d/df/level-veggie-bistro.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-s/1c/ad/34/0c/photo1jpg.jpg",
    ],
  },
  {
    title: "Eiffel",
    address: "Seseña 18 Close to Zoo and amussement park, 28024 Madrid Spain",
  ...
  },
  {
    ...
    address: "Calle Espartinas 7, 28001 Madrid Spain",
    phone: "+34 914 35 62 32",
    cols2: [
      "€14 - €40",
      "Indian, Asian, Nepali, Healthy",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "Arpit",
    address: "Calle Maria Tubau 19, 28050 Madrid Spain",
  ...
  },
  {
    ...
    address: "Calle de la Union 1, 28013 Madrid Spain",
  ...
  },
  {
    ...
    address: "Aviador Zorita, 50 Near by Santiago Bernabéu, 28020 Madrid Spain",
  ...
  {
    title: "Kai Thai",
    address: "Calle de la Princesa 13 Local 3, 28008 Madrid Spain",
    ...
    img: [
      ...
      "https://media-cdn.tripadvisor.com/media/photo-f/19/68/e2/9e/tom-yam-kung-sopa-tradicional.jpg",
  ...
  },
  {
    ...
    cols2: [
      "€4 - €11",
      "Mexican, Latin, Fast Food, Central American",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  },
  {
    ...
    address: "Calle Breton de los Herreros 45, 28003 Madrid Spain",
    phone: "+34 911 10 73 77",
    cols2: [
      "€10 - €15",
      "Asian, Vietnamese, Soups, Fusion",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "Oliveto",
    address: "Calle Santa Isabel 45, 28012 Madrid Spain",
  ...
  {
    title: "Vega",
    address: "Calle Luna 9, 28004 Madrid Spain",
  ...
  {
    title: "La Hummuseria",
    address: "Calle Hernan Cortes 8, 28004 Madrid Spain",
    phone: "+34 910 22 62 40",
    cols2: [
      "€8 - €15",
      "Mediterranean, Healthy, Middle Eastern, Israeli",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  },
  {
    ...
    address: "Calle Clavel 7, 28004 Madrid Spain",
    phone: "+34 910 14 61 03",
    cols2: ["€12 - €32", "Thai, Healthy", "Vegan Options, Gluten Free Options"],
    img: [
  ...
  {
    title: "Lune Creperie",
    address: "Paseo la Chopera 33 Local 1, 28045 Madrid Spain",
    phone: "+34 919 21 70 05",
    cols2: ["€6 - €11", "French", "Vegetarian Friendly, Vegan Options"],
    img: [
  ...
  },
  {
    ...
    address: "Calle Embajadores 197, 28045 Madrid Spain",
    phone: "+34 912 30 22 98",
    cols2: [
      "€15 - €35",
      "Italian, Mediterranean, Healthy, Tuscan, Romana, Lazio, Central-Italian",
  ...
  },
  {
    ...
    address: "Calle Alonso de Heredia 22, 28028 Madrid Spain",
  ...
  {
    title: "Jack Percoca",
    address: "Calle Conde Duque 14, 28015 Madrid Spain",
  ...
  {
    title: "La Bistroteca",
    address: "Calle Espartinas 7 Barrio Salamanca, 28001 Madrid Spain",
    phone: "+34 914 25 86 01",
    cols2: ["€20 - €25", "Fusion", "Vegetarian Friendly, Gluten Free Options"],
    img: [
  ...
  {
    title: "Periplo Cafe",
    address: "Calle Modesto Lafuente 4, 28010 Madrid Spain",
    phone: "+34 622 63 89 74",
    cols2: [
      "€5 - €10",
      "Bar, Mediterranean, Greek, Gastropub, European",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "La Piramide",
    address: "Calle Xaudaro 2, 28034 Madrid Spain",
    phone: "+34 917 29 42 95",
    cols2: [
      "€16 - €60",
      "Mediterranean, European, International, Spanish, Fusion, Healthy, Soups",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "Pizzart Villa Fuencarral",
    address: "Fuencarral 58, 28004 Madrid Spain",
    phone: "+34 911 08 89 91",
    cols2: [
      "€9 - €18",
      "Italian, Pizza, Romana, Lazio, Central-Italian, Southern-Italian, Mediterranean, Neapolitan, Campania, Sicilian",
      "Vegetarian Friendly, Vegan Options",
    ],
    img: [
  ...
  },
  {
    ...
    cols2: [
      "€25 - €45",
      "International, Fusion, Mediterranean, European, Spanish",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  },
  {
    ...
    address: "Calle Moratin 19 Esquina Calle San Jose, 28014 Madrid Spain",
    phone: "+34 911 74 63 68",
    cols2: [
      "€3 - €25",
      "Latin, Mediterranean, Spanish, Venezuelan",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "Gato Gato",
    address: "Calle del Marques de Toca 6 Lavapiés, 28012 Madrid Spain",
    phone: "+34 912 08 68 70",
    cols2: [
      "€9 - €26",
      "Spanish, Mediterranean, European, Healthy, Contemporary",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  },
  {
    ...
    cols2: [
      "€6 - €20",
      "Contemporary, Mediterranean, Healthy",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "Vega Alamo",
    address: "Calle del Alamo 3, 28015 Madrid Spain",
    phone: "+34 910 70 37 19",
    cols2: [
      "€10 - €30",
      "Healthy, International, Contemporary, Fusion",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  },
  {
    ...
    cols2: [
      "€11 - €29",
      "Italian, Healthy, Neapolitan, Campania, Romana, Lazio, Sicilian, Central-Italian, Southern-Italian",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "Arbonaida Bar",
    address: "Calle Santiago 11, 28013 Madrid Spain",
  ...
  {
    title: "Okashi Sanda",
    address: "Calle San Vicente Ferrer 22, 28004 Madrid Spain",
    phone: "+34 913 65 44 02",
    cols2: [
      "€18 - €22",
      "Japanese, Asian",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ...
    img: [
      "https://media-cdn.tripadvisor.com/media/photo-s/10/bb/53/a9/kare-raisu-guiso-de-curry.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-s/10/bb/53/97/poteto-sarada-ensalada.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-s/05/13/7b/bd/okashi-sanda.jpg",
    ],
  },
  {
    title: "Maruzzella",
    ...
    cols2: [
      "€15 - €30",
      "Italian, Pizza, Neapolitan, Campania, Tuscan, Romana, Lazio, Sicilian, Central-Italian, Southern-Italian",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  },
  {
    ...
    address: "Calle Goya 110, 28009 Madrid Spain",
  ...
  {
    title: "Deleïte Restaurante",
    address:
      "Avenida de Logrono 327 Corner with Calle de Algemesi, 28042 Madrid Spain",
  ...
  },
  {
    ...
    address: "Calle Gaztambide 56 Gaztambide 56, 28015 Madrid Spain",
  ...
  {
    title: "Amicis",
    address: "Plaza del Conde de Miranda 4, 28005 Madrid Spain",
  ...
  {
    title: "EatMyTrip Brunch & Bakery Madrid",
    address: "Calle Moreria 11 Almudena cathedral nearby, 28005 Madrid Spain",
    phone: "+34 611 15 10 30",
    cols2: [
      "€2 - €16",
      "American, Cafe, International, Spanish, Fusion, Healthy",
      "Vegan Options, Gluten Free Options",
    ],
    img: [
  ...
  {
    title: "Superchulo",
    address: "Calle Manuela Malasaña, 28004 Madrid Spain",
    phone: "+34 910 23 27 06",
    cols2: [
      "€15 - €30",
      "Mediterranean, European, Healthy, Gastropub",
      "Vegetarian Friendly, Vegan Options, Gluten Free Options",
    ],
    img: [
      "https://media-cdn.tripadvisor.com/media/photo-p/13/e8/3a/e4/superchulo.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-s/12/a7/a6/db/green-baos.jpg",
      "https://media-cdn.tripadvisor.com/media/photo-s/12/a7/a6/e6/postres.jpg",
    ],
  },
  {
    title: "Periplo Cafe",
